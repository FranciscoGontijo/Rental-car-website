    ...
    return (
        <section className="home-page-FAQ-container">
            ...
            <div className="questions-container">
                <button onClick={() => status === 'hidden' ? setStatus('shown1') : setStatus('hidden')} className="question-button"><p>1. What is special about comparing rental car deals?</p><i>icon</i></button>
                {status === "shown1" && <div onClick={() => setStatus('hidden')} className="answer">
                ...
                <button onClick={() => status === 'hidden' ? setStatus('shown2') : setStatus('hidden')} className="question-button"><p>2. How do I find the car rental deals?</p><i>icon</i></button>
                {status === "shown2" && <div onClick={() => setStatus('hidden')} className="answer">
                ...
                <button onClick={() => status === 'hidden' ? setStatus('shown3') : setStatus('hidden')} className="question-button"><p>3. How do I find such low rental car prices?</p><i>icon</i></button>
                {status === "shown3" && <div onClick={() => setStatus('hidden')} className="answer">
